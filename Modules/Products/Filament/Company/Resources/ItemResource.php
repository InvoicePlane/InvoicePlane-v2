...
class ItemResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('item_name')->limit(10)->searchable()->sortable()->toggleable(),
                Tables\Columns\TextColumn::make('type')
                    ->formatStateUsing(fn ($state) => ($state instanceof ItemType ? $state : ItemType::tryFrom($state))?->label())
                    ->searchable()
                    ->sortable()
                    ->toggleable(),
    ...
    {
        return [
            ItemResource\RelationManagers\ProductCategoryRelationManager::class,
            ItemResource\RelationManagers\InvoiceItemsRelationManager::class,
            ItemResource\RelationManagers\QuoteItemsRelationManager::class,
            ItemResource\RelationManagers\ProductUnitRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => ItemResource\Pages\ListItems::route('/'),
        ];
    }
}
