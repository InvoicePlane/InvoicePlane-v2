...
class DetailInvoiceProductBrick extends ReportBrick
{
    ...
    {
        return view('core::report-builder.bricks.detail-invoice-product.preview', [
            'config' => $config,
        ])->render();
    }
    ...
    {
        return view('core::report-builder.bricks.detail-invoice-product.index', [
            'config' => $config,
            'data'   => $data ?? [],
        ])->render();
    }
