...
class HeaderInvoiceMetaBrick extends ReportBrick
{
    ...
    {
        return view('core::report-builder.bricks.header-invoice-meta.preview', [
            'config' => $config,
        ])->render();
    }
    ...
    {
        return view('core::report-builder.bricks.header-invoice-meta.index', [
            'config' => $config,
            'data'   => $data ?? [],
        ])->render();
    }
