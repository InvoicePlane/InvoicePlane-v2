...
<x-filament-panels::page>
    <div class="w-full">
        <div class="w-full"
            ...
            availableBlocks: @js(array_values(array_map(fn($type, $blockDto) => ['id' => $type, 'label' => $blockDto->getLabel(), 'slug' => $blockDto->getSlug()], array_keys($systemBlocks), $systemBlocks))),
            hoveredBand: null,
            dragBlockId: null,
        ...
        >
            ...
            <div class="w-full gap-8 items-start"
                                    ...
                                    >
                                        <div class="flex items-center justify-between w-full mb-1">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <button
                                                    type="button"
                                                    @click.stop="console.log('Clicked block for config:', block.id, 'Full Block Object:', JSON.stringify(block, null, 2)); $wire.setCurrentBlockId(block.id); $wire.mountAction('configureBlock', { blockSlug: block.id })"
                                        ...
                                        <div
                                            ...
                                            @click.stop="console.log('Clicked block:', block.id); $wire.setCurrentBlockId(block.id); $wire.mountAction('configureBlock', { blockSlug: block.id })"
                                        >
                                            <span
                ...
                <div class="sticky"
                    ...
                    <div
                        class="bg-gray-200 dark:bg-gray-900 border-b-4 border-gray-200 dark:border-white/10 rounded-2xl shadow-xl overflow-hidden"
                        ...
                        <div class="bg-[#FF0000] dark:bg-gray-900">
                            <div class="grid grid-cols-1 gap-4">
                                <template x-for="block in availableBlocks" :key="block.id">
                                    ...
                                    >
                                        ...
                                        <span
                                            class="text-sm font-[#429AE1] text-white uppercase tracking-tight overflow-hidden text-ellipsis w-full"
                                            style="white-space: nowrap !important; align-self: flex-start !important;"
                                            x-html="block.label.replace(/ /g, '&nbsp;')"></span>
                                    </div>
                                </template>
