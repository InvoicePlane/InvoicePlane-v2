...
<table>
    <tr>
        <td style="width: 50%;" valign="top">
            ...
            <span class="info">{{ mb_strtoupper(trans('ip.bill_to')) }}</span><br>{{ $invoice->customer->name }}<br>
        ...
        <td style="width: 50%; text-align: right;" valign="top">
            ...
            @if ($invoice->companyProfile->phone)
                {{ $invoice->companyProfile->phone }}<br>
            @endif
            @if ($invoice->user->email)
                <a
                    href="mailto:{{ $invoice->user->email }}">{{ $invoice->user->email }}</a>
            @endif
        </td>
    </tr>
</table>
