...
class QuoteItems implements SourceInterface
{
    public function getResults($params = [])
    {
        $quoteItem = QuoteItem::select(
            ...
            'quote_item_amounts.tax_1 AS tax_rate_1_amount',
            ...
            'quote_item_amounts.tax_2 AS tax_rate_2_amount',
            'quote_item_amounts.subtotal',
            'quote_item_amounts.tax',
